...
@Resource(name = RestConstants.VERSION_1 + "/personattributetype", supportedClass = PersonAttributeType.class, supportedOpenmrsVersions = {"1.12.*","2.0.*", "2.1.*", "2.2.*", "2.3.*", "2.4.*"}, order = 0)
