...
public class BahmniOrderSetMemberControllerIT extends BahmniMainResourceControllerTest {
    ...
    public String getURI() {
        return "bahmniorderset/" + orderSetUuid + "/bahmniordersetmember";
    }
    ...
    public void shouldEditAnOrderSetMember() throws Exception {
        OrderSetMember orderSetMember = Context.getService(RestHelperService.class).getObjectByUuid(OrderSetMember.class, orderSetMemberUuid);
