...
import org.openmrs.*;
import org.openmrs.module.bahmniemrapi.diagnosis.helper.BahmniDiagnosisConceptSetDescriptor;
 ...
 */
@Component("emrApiProperties") @Primary
public class EmrApiProperties extends ModuleProperties {
	...
	public BahmniDiagnosisConceptSetDescriptor getDiagnosisMetadata() {
		return new BahmniDiagnosisConceptSetDescriptor(conceptService, getEmrApiConceptSource());
	}
